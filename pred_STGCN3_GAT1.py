...
def getModel(name):
    ks, kt, bs, T, n, p = 3, 3, [[CHANNEL3, 16, 64], [64, 16, 64]], INPUT_STEP, N_NODE, 0
...
def trainModel(name, mode, XS, YS):
    ...
    model = getModel(name)
    summary(model, (CHANNEL3, INPUT_STEP, N_NODE), device=device)
...
################# Parameter Setting #######################
MODELNAME = 'STGCN3_GAT1_resx_embed64_tanh_zscore_single'+str(args.horizon)
...
def main():
    ...
    shutil.copy2('pred_STGCN3.py', PATH)
