...
def getModel(name):
    model = GAT2_Transformer(in_channel = CHANNEL, embed_size = 32, time_num = 82 , num_layers = 3, T_dim = INPUT_STEP, output_T_dim = 1, heads = 4, forward_expansion = 4, gpu = device, dropout = 0).to(device)
    return model
...
################# Parameter Setting #######################
MODELNAME = 'GAT2_Transformers_catx_Tanh_horizon_'+str(args.horizon)
